...
- [AdGuard Home (HOST)]() - Network Mode is host. Network-wide ads & trackers blocking DNS server.
...
- [Big Bear CasaOS User Management]() - Manage users in CasaOS
- [bookstack]() - BookStack
- [Brave]() - Brave
...
- [IT Tools]() - IT Tools
- [Jellyseerr]() - Jellyseerr is a free and open source software application for managing requests for your media library. It is a fork of Overseerr built to bring support for Jellyfin & Emby media servers!
- [Jellystat]() - Jellystat
...
- [Mailpit]() - Mailpit
- [Matterbridge]() - Matter plugin manager for smart home devices
- [Mealie]() - Mealie
...
- [Music Assistant]() - Home Automation
...
- [Password Pusher]() - Give your users the tools to be secure by default.
- [PD3F]() - PD3F
...
- [Playit Docker Web]() - Playit.gg is a global proxy that allows anyone to host a server without port forwarding.
...
- [Plex with NVIDIA GPU]() - Stream Movies & TV Shows with NVIDIA GPU
- [Plex]() - Stream Movies & TV Shows
- [Pocket ID]() - Passkey-based OIDC authentication
- [Portainer Agent]() - Portainer Agent
- [Portainer]() - Portainer
- [Portracker]() - Real-time Port Monitoring Tool
- [Poste.io]() - Free version of full mail server solution. POP3, SMTP, IMAP, Spamassassin, WebMail, WebAdmin
...
- [TP-Link Omada Controller]() - TP-Link Omada Controller
- [Traccar]() - Traccar
